...
ANALYSES = [
    'dalphaT.toml',
    'dalphaT_xSecUncertainty.toml',
    'dalphaT_xSecUncertainty_Exp.toml',
    'dalphaT_FluxUncertainty.toml',
    'dalphaT_FluxUncertainty_Exp.toml',
    'dalphaT_DetectorUncertainty.toml',
]
