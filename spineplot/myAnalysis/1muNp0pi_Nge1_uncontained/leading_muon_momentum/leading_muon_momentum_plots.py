...
ANALYSES = [
    'leading_muon_momentum.toml',
    'leading_muon_momentum_xSecUncertainty.toml',
    'leading_muon_momentum_xSecUncertainty_Exp.toml',
    'leading_muon_momentum_FluxUncertainty.toml',
    'leading_muon_momentum_FluxUncertainty_Exp.toml',
    'leading_muon_momentum_DetectorUncertainty.toml',
]
