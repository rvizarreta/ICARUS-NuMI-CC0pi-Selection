...
ANALYSES = [
    'vertex_x.toml',
    'vertex_x_xSecUncertainty.toml',
    'vertex_x_xSecUncertainty_Exp.toml',
    'vertex_x_FluxUncertainty.toml',
    'vertex_x_FluxUncertainty_Exp.toml',
    'vertex_x_DetectorUncertainty.toml',
]
