...
ANALYSES = [
    'leading_pion_length.toml',
    'leading_pion_length_xSecUncertainty.toml',
    'leading_pion_length_xSecUncertainty_Exp.toml',
    'leading_pion_length_FluxUncertainty.toml',
    'leading_pion_length_FluxUncertainty_Exp.toml',
    'leading_pion_length_DetectorUncertainty.toml',
]
