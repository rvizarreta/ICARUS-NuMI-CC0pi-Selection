...
ANALYSES = [
    'vertex_z.toml',
    'vertex_z_xSecUncertainty.toml',
    'vertex_z_xSecUncertainty_Exp.toml',
    'vertex_z_FluxUncertainty.toml',
    'vertex_z_FluxUncertainty_Exp.toml',
    'vertex_z_DetectorUncertainty.toml',
]
