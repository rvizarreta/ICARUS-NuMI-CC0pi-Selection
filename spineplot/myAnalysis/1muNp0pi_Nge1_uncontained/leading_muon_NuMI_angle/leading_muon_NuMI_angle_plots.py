...
ANALYSES = [
    'leading_muon_NuMI_angle.toml',
    'leading_muon_NuMI_angle_xSecUncertainty.toml',
    'leading_muon_NuMI_angle_xSecUncertainty_Exp.toml',
    'leading_muon_NuMI_angle_FluxUncertainty.toml',
    'leading_muon_NuMI_angle_FluxUncertainty_Exp.toml',
    'leading_muon_NuMI_angle_DetectorUncertainty.toml',
]
